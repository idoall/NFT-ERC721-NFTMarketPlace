// npx hardhat run script/ERC721/02-deploy-MSHKNFT.js --network localhost
const { deployments, getNamedAccounts } = require("hardhat");
const { deploy, log } = deployments

async function main() {

    const NFTContractName = "MSHK721NFT"
    // 获取部署的用户
    ...
    const tokenContrace = await deploy(NFTContractName, {
    ...
    console.log(`${NFTContractName} Contract deployed address -> ${tokenContrace.address}`);
